...
const query_builder_container = $(
    ...
    query_builder_tags_clauses = $(`<div id="sqlqb-tags-clauses"><h4 class="sqlqb-header">Clauses</h4></div>`),
    query_builder_tags_operators = $(`<div id="sqlqb-tags-operators"><h4 class="sqlqb-header">Operators</h4></div>`),
